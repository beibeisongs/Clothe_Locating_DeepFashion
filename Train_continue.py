...
def __data_label__(path):
    ...
    while line_i < len(lines):
        ...
        new_x1, new_y1 = adjust_landmarks(images.shape[0], images.shape[1], step_2[mark_i + 3], step_2[mark_i + 4])
        new_x2, new_y2 = adjust_landmarks(images.shape[0], images.shape[1], step_2[mark_i + 7], step_2[mark_i + 8])
        new_x3, new_y3 = adjust_landmarks(images.shape[0], images.shape[1], step_2[mark_i + 11], step_2[mark_i + 12])
        new_x4, new_y4 = adjust_landmarks(images.shape[0], images.shape[1], step_2[mark_i + 15], step_2[mark_i + 16])
        new_x5, new_y5 = adjust_landmarks(images.shape[0], images.shape[1], step_2[mark_i + 19], step_2[mark_i + 20])
        new_x6, new_y6 = adjust_landmarks(images.shape[0], images.shape[1], step_2[mark_i + 23], step_2[mark_i + 24])
