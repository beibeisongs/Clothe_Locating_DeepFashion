...
def adjust_landmarks(shape_y, shape_x, mark_x, mark_y, img_whole_path):
    ...
    try:
        ...
        print("mark_x : ", mark_x)
        print("image_whole_path : ", img_whole_path)
        exit(1)
...
def __data_label__(path):
    ...
    for line in f.readlines():
        ...
        new_x1, new_y1 = adjust_landmarks(images.shape[0], images.shape[1], step_2[28], step_2[29], img_whole_path)
        new_x2, new_y2 = adjust_landmarks(images.shape[0], images.shape[1], step_2[32], step_2[33], img_whole_path)
        new_x3, new_y3 = adjust_landmarks(images.shape[0], images.shape[1], step_2[36], step_2[37], img_whole_path)
        new_x4, new_y4 = adjust_landmarks(images.shape[0], images.shape[1], step_2[40], step_2[41], img_whole_path)
        new_x5, new_y5 = adjust_landmarks(images.shape[0], images.shape[1], step_2[44], step_2[45], img_whole_path)
        new_x6, new_y6 = adjust_landmarks(images.shape[0], images.shape[1], step_2[48], step_2[49], img_whole_path)
